#!/usr/bin/env python
"""Run SOC Analyst Tier 2 A2A agent as a standalone server."""
...
from manager.sub_agents.soc_analyst_tier2.agent_a2a import SOCAnalystTier2A2A
...
# Create FastAPI app
app = FastAPI(title="SOC Analyst Tier 2 A2A Agent")

# Initialize the agent
agent = SOCAnalystTier2A2A()
...
async def root():
    ...
    return {
        ...
        "description": "SOC Tier 2 Analyst specializing in alert triage and initial investigation",
...
async def shutdown_event():
    ...
    logger.info("Shutting down SOC Analyst Tier 2 agent...")
    await agent.cleanup()
