...
class SOCAnalystTier2A2A:
    """An agent that handles SOC Tier 2 alert triage with A2A integration and full MCP tools."""
    ...
    def _build_agent(self) -> LlmAgent:
        """Builds the LLM agent for the SOC Tier 2 analyst with A2A capabilities."""
