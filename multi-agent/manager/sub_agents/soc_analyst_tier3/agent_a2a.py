...
class SOCAnalystTier3A2A:
    ...
    def _build_agent(self) -> LlmAgent:
        ...
        tool_card_files = [
            (BASE_DIR / "../../tool_cards/create_advanced_investigation_form.md").resolve(),
            (BASE_DIR / "../../tool_cards/return_advanced_investigation_form.md").resolve(),
            (BASE_DIR / "../../tool_cards/initiate_advanced_investigation.md").resolve(),
