#!/usr/bin/env python
"""Run SOC Analyst Tier 3 A2A agent as a standalone server."""
...
from manager.sub_agents.soc_analyst_tier3.agent_a2a import SOCAnalystTier3A2A
...
# Create FastAPI app
app = FastAPI(title="SOC Analyst Tier 3 A2A Agent")
...
async def root():
    ...
    return {
        ...
        "description": "SOC Tier 3 Analyst specializing in advanced investigation and threat hunting.",
        "instructions": "Send complex security incidents for deep investigation.",
...
async def shutdown_event():
    ...
    logger.info("Shutting down SOC Analyst Tier 3 agent...")
    await agent.cleanup()
