...
def get_agent(tools, exit_stack):
  ...
  try:
    ...
    persona_description = "Default SOC Analyst Tier 1 description: Responsible for initial alert triage and basic IOC enrichment." # Corrected default description
