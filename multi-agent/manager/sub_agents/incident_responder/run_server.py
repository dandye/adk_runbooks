#!/usr/bin/env python
"""Run Incident Responder A2A agent as a standalone server."""
...
from manager.sub_agents.incident_responder.agent_a2a import IncidentResponderA2A
...
# Create FastAPI app
app = FastAPI(title="Incident Responder A2A Agent")
...
async def root():
    ...
    return {
        ...
        "description": "Incident Responder specializing in containing and eradicating threats.",
        "instructions": "Send incidents for containment and eradication.",
...
async def shutdown_event():
    ...
    logger.info("Shutting down Incident Responder agent...")
    await agent.cleanup()
